          ...
          <div className="bg one w-full h-full absolute top-0 flex items-center justify-center bg-cover bg-no-repeat bg-[url('/assets/images/city-background-3.png')]">
            <div className="w-10/12 mx-auto h-full pt-28 flex flex-col justify-start md:flex-row-reverse md:justify-center md:items-center md:gap-10 ">
              ...
              <div className="w-full h-auto uppercase text-center font-chakra-petch">
                <h2
                  className="text-white text-4xl md:text-left md:text-5xl md:pb-4"
                  id="aboutText"
                >
                  About Me
                </h2>
                <div className="about py-4 text-left">
                  <p className="text-white">Name: Siraphop Tinthuwanon</p>
                  <p className="py-4 text-white">Nickname: Fa</p>
                  <div className="w-full h-full p-4 bg-[rgba(0,0,0,0.7)]">
                    <p className="pb-4 text-lg text-white">Education</p>
                    <p className="text-white">Degree: Bachelor of Arts </p>
                    <p className="text-white">Major: Information Studies </p>
                    <p className="text-white">Faculty: Humanities</p>
                    <p className="text-white">University: Chiang mai university</p>
                    <p className="text-white">GPA: 3.01 / 4.0</p>
                  </div>
                </div>
              </div>
